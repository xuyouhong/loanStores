...
class CreateLoanStoresBrandNearMeFoundPositionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('loan_stores_brand_near_me_found_position', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('loan_stores_brand_near_me_found_position');
    }
}
